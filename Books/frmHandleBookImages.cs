...
namespace Library.Books
{
    public partial class frmHandleBookImages : Form
    {
        ...
        {
            btn1Right.Visible = (Images[0] != null && Images[1] != null);
            btn2Left.Visible = btn1Right.Visible;

            btn2Right.Visible = (Images[1] != null && Images[2] != null);
            btn3Left.Visible = btn2Right.Visible;
        }
